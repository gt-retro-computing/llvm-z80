...
//                         MVT XLenVT) {
//
//  SDValue ZeroReg = CurDAG->getRegister(Z80::r0, XLenVT);
//
//  if (isInt<16>(Imm)) {
//    SDValue SDImm = CurDAG->getTargetConstant(Imm, DL, XLenVT);
//
//    return CurDAG->getMachineNode(Z80::ADDI, DL, XLenVT, ZeroReg, SDImm);
//  } else if (isInt<32>(Imm)) {
//    SDValue SDImm = CurDAG->getTargetConstant(Imm, DL, XLenVT);
//
//    return CurDAG->getMachineNode(Z80::ADD32, DL, XLenVT, ZeroReg, SDImm);
//  }
//
...
//        SDValue New = CurDAG->getCopyFromReg(CurDAG->getEntryNode(), SDLoc(Node),Z80::r0, XLenVT);
...
//      ReplaceNode(Node, CurDAG->getMachineNode(Z80::ADDI, DL, VT, TFI, Imm));
//      return;
//    }
//  }
